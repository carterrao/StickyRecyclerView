package com.rzc.stickyrecyclerview.demo.scrollheaderfooterlistview;
...
public class ScrollHeaderFooterListViewActivity extends Activity {
    private ProgressDialog mProgressDialog;
    private TextView tvTitle;
    private View header;
    private StickyRecyclerView mStickyRecyclerView;
    private StickyRecyclerViewAdapter<ScrollHeaderFooterListViewActivity.ProvinceHolder, BaseChildHolder, Province, Object> mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scroll_header_footer_list_view_activity);

        tvTitle = findViewById(R.id.tvTitle);
        mStickyRecyclerView = findViewById(R.id.mStickyRecyclerView);

        header = View.inflate(this, R.layout.scroll_header_footer_list_view_header, null);
        final ImageView headerPic = header.findViewById(R.id.ivPic);
        ...
        View footer = View.inflate(this, R.layout.scroll_header_footer_list_view_footer, null);
        ...
        mAdapter = new StickyRecyclerViewAdapter<ProvinceHolder, BaseChildHolder, Province, Object>(mStickyRecyclerView) {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (getFirstVisibleViewHolderType() > StickyRecyclerViewHolderType.HOLDER_TYPE_HEADER
                        || header.getHeight() + getHeaderTop() <= tvTitle.getMeasuredHeight()) {
            ...
            public ProvinceHolder newGroupHolder() {
                return new ProvinceHolder(View.inflate(ScrollHeaderFooterListViewActivity.this, R.layout.simple_list_view_list_item, null));
            }
            ...
            public void bindGroupHolder(ProvinceHolder holder, Province data, int groupIndex, boolean expand) {
                if (!TextUtils.isEmpty(data.picUrl)) {
                    Glide.with(ScrollHeaderFooterListViewActivity.this).load(data.picUrl)
